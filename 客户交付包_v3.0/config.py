...
API_KEY_CONFIG = {
    ...
    'ASR_API_KEY': "OjBAo0bZXmeOE76weLUPtKkj",      # ASR API密钥
    'TTS_API_KEY': "OjBAo0bZXmeOE76weLUPtKkj",     # TTS API密钥
    'ASR_SECRET_KEY': "dBF1UBMdxXb3nz4gOJrBLOADkANrFNQ3",  # ASR密钥
    'TTS_SECRET_KEY': "dBF1UBMdxXb3nz4gOJrBLOADkANrFNQ3",  # TTS密钥
    'ASR_APP_ID': "119399339", # ASR应用ID
    'TTS_APP_ID': "119399339"  # TTS应用ID
}
